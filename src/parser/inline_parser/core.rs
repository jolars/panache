...
// Import inline element parsers
use crate::parser::inline_parser::bracketed_spans::{
    emit_bracketed_span, try_parse_bracketed_span,
};
use crate::parser::inline_parser::citations::{
    emit_bare_citation, emit_bracketed_citation, try_parse_bare_citation,
    try_parse_bracketed_citation,
};
use crate::parser::inline_parser::code_spans::{emit_code_span, try_parse_code_span};
use crate::parser::inline_parser::escapes::{EscapeType, emit_escape, try_parse_escape};
use crate::parser::inline_parser::inline_footnotes::{
    emit_footnote_reference, emit_inline_footnote, try_parse_footnote_reference,
    try_parse_inline_footnote,
};
use crate::parser::inline_parser::latex::{parse_latex_command, try_parse_latex_command};
use crate::parser::inline_parser::links::{
...
use crate::parser::inline_parser::math::{
...
use crate::parser::inline_parser::native_spans::{emit_native_span, try_parse_native_span};
use crate::parser::inline_parser::raw_inline::is_raw_inline;
use crate::parser::inline_parser::shortcodes::{emit_shortcode, try_parse_shortcode};
use crate::parser::inline_parser::strikeout::{emit_strikeout, try_parse_strikeout};
use crate::parser::inline_parser::subscript::{emit_subscript, try_parse_subscript};
use crate::parser::inline_parser::superscript::{emit_superscript, try_parse_superscript};
...
fn parse_inline_range_impl(
    ...
    while pos < end {
                ...
                try_parse_code_span(&text[pos..])
        {
            ...
            {
                use crate::parser::inline_parser::raw_inline::emit_raw_inline;
