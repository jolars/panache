...
Description
:   Parser errors indicate syntactically invalid Markdown that panache cannot
    parse correctly. These should be fixed manually as they typically indicate
...
Each key is a rule name and each value is a boolean (`true`/`false`).
