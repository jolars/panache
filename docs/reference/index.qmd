...
- In [Lint Rules](linter-rules.qmd) you can find the catalogue of every built-in
  lint rule, the diagnostic codes each rule emits, severity, auto-fix support,
  and any configuration requirements.
