...
* `cache` — Manage Panache CLI cache data
...
Manage Panache's on-disk CLI cache data.

**Usage:** `panache cache <COMMAND>`

###### **Subcommands:**

* `clean` — Delete CLI cache data
...
**Usage:** `panache cache clean [OPTIONS]`

###### **Options:**

* `--all` — Remove all Panache CLI cache buckets
