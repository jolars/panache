...
title: "Panache"
title-meta: >-
  Panache: Language Server, Formatter, and Linter for Markdown, Quarto, and R
  Markdown
description-meta: >
...
width="330" height="375" style="max-width: 20%; height: auto;">
...
- **Fast and reliable**: built in Rust for speed and stability, with a focus on
  ...
  [Comparisons](guide/comparison.qmd) and [Performance](guide/performance.qmd)
