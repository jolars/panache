...
description: >
  ...
  the CLI, verify it works, run the core commands (`format`, `lint`, and `parse`),
  and learn the minimum configuration and ignore directives you need for
  day-to-day editing.
---
...
your platform, you can use the installer scripts
below.^[These scripts download from this repository's latest GitHub release and install to a user-local directory by default. If you prefer, download and inspect the script before running it.]
