...
- **Go to definition** (`textDocument/definition`) - jump from references to definitions
...
- Folding ranges (`textDocument/foldingRange`) - code folding for headings, code blocks, fenced divs, YAML frontmatter
...
Install the
[Custom LSP](https://marketplace.visualstudio.com/items?itemName=josa.custom-lsp)
