...
File rename
:   Update links to a renamed Markdown file (`workspace/willRenameFiles`)
...
When you rename a Markdown file in an LSP-aware editor, the server returns a
workspace edit that rewrites links pointing at the old path
(`workspace/willRenameFiles`), so cross-document links stay intact. Renaming
other linked file types (images, data files) is not yet handled.
...
marked *out of scope*.
  ...
  | `workspace/willRenameFiles`                                                                                                 | ✅     | Markdown files only                                 |
