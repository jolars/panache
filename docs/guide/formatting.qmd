...
never broken at. A unary `+`/`-` is never a break point. An equation with no
top-level relation chain is left on one line even when it overflows. The option
is unstable and may change without a major release --- see [Experimental
